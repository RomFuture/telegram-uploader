...
> ⚠️ **Архив (2026-06-11).** Вся архитектура и план рефакторинга слиты в **[docs/PROJECT.md](docs/PROJECT.md)**. Фичи → [BACKLOG.md](docs/BACKLOG.md). Client API → [TELEGRAM_CLIENT_API_MIGRATION.md](docs/TELEGRAM_CLIENT_API_MIGRATION.md). **Не использовать этот файл для планирования.**
